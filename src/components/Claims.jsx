...
const Claims = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/hospital-claim`, {
        method: 'POST',
        headers: {
                        ...
                        <Column sm={4} md={4} lg={8}>
                          <div style={{ width: 300 }}>
                            <TextInput
                              ...
                              labelText={<span>Patient Name <span style={{color: 'red'}}>*</span></span>}
                        ...
                        <Column sm={4} md={4} lg={8}>
                          <div style={{ width: 300 }}>
                            <TextInput
                              ...
                              invalidText="Error message goes here"
                              warnText="Warning message that is really long can wrap to more lines but should not be excessively long."
                              labelText={<span>Phone Number <span style={{color: 'red'}}>*</span></span>}
                        ...
                        <Column sm={4} md={4} lg={8}>
                          <div style={{ width: 300 }}>
                            <TextInput
                              ...
                              invalidText="Error message goes here"
                              warnText="Warning message that is really long can wrap to more lines but should not be excessively long."
                              labelText={<span>Claim Amount <span style={{color: 'red'}}>*</span></span>}
                              placeholder="Enter claim amount"
                              value={form.claimAmount}
                              onChange={e => {
                                // Only allow digits
                                const value = e.target.value.replace(/\D/g, "");
                                handleInputChange({ target: { name: "claimAmount", value } });
                              }}
                              inputMode="numeric"
                              pattern="[0-9]*"
                              required
